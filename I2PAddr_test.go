...
func TestNewI2PAddrFromString(t *testing.T) {
...
func TestLoadKeysIncompat(t *testing.T) {
	testKeys := "testpub\ntestpriv"
...
func TestStoreKeysIncompat(t *testing.T) {
...
func TestDestHashFromString(t *testing.T) {
...
func TestI2PAddrToBytes(t *testing.T) {
	addr := I2PAddr(validI2PAddrB64)
